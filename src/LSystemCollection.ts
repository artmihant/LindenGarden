...
const LSystemCollection: LSystemCollectionItem[] = [
    {
        ...
        drawSettings: {
            'Л': { color: '#00ff00', lineWidth: 2, lineHeight: 1},
            'В': { color: '#2c1d00', lineWidth: 2, lineHeight: 1 },
        },
        defaultSetting: { color: '#000000', lineWidth: 2 },
    ...
    },
    {
        ...
        drawSettings: {},
        defaultSetting: { color: '#2f0272', lineWidth: 2 },
    ...
    },
    {
        ...
        drawSettings: {
            'A': { color: '#ee2a2a', lineWidth: 2 },
            'B': { color: '#cc0000', lineWidth: 2 },
            'F': { color: '#ea0a0a', lineWidth: 2 },
        },
        defaultSetting: { color: '#000000', lineWidth: 2 },
        start: { x: 0, y: 0, angle: 0 },
        power: 2,
    },
    {
        ...
        drawSettings: {},
        defaultSetting: { color: '#0ac8ea', lineWidth: 2 },
        start: { x: 150, y: 50, z: 0 },
        power: 1.3,
    },
    {
        name: 'Кривая Леви',
        ...
        drawSettings: {},
        defaultSetting: { color: '#3100c2', lineWidth: 2 },
    ...
    },
    {
        ...
        drawSettings: {},
        defaultSetting: { color: '#46e100', lineWidth: 2 },
        start: { x: 0, y: 0, angle: 0 },
        power: 2,
    },
    {
    ...
    },
    {
        ...
        drawSettings: {},
        defaultSetting: { color: '#cc0000', lineWidth: 2 },
    ...
    },
    {
        ...
        drawSettings: {},
        defaultSetting: { color: '#003acc', lineWidth: 2 },
        start: { x: -100, y: -250, angle: 0 },
        power: 2,
    },
];
